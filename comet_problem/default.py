...
default_problem = {
    ...
    'parameters': [
        {'name': 'Lifetime', 'units': 'Years', 'type': 'int', 'value': '3'},
        ...
        {'name': 'Inclination', 'units': 'Deg', 'type': 'int', 'value': '50'},
        ...
        {'name': 'Eccentricity', 'units': 'none', 'type': 'float', 'value': '0.0'},
        {'name': 'Argument Of Periapsis', 'units': 'degrees', 'type': 'float', 'value': '0.0'},
        {'name': 'True Anomaly', 'units': 'degrees', 'type': 'float', 'value': '0.0'},
    ],
