...
from comet_problem.aws.utils import call_boto3_client_async


vpc_id = 'vpc-00f24d831dbe99d4a'
    ...
    async def get_user_active_instances_all(user_id, resource_type):
        ...
        async def query_status(instance_ids, results):
            if len(instance_ids) == 0:
                return []
            request = await call_boto3_client_async('ec2', 'describe_instance_status', {"InstanceIds": instance_ids},
                                                    True)
